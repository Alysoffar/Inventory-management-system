...
.purchases-management .btn-primary {
    background-color: var(--aws-color-orange-600) !important;
    border-color: var(--aws-color-orange-600) !important;
    color: white !important;
    font-weight: 600 !important;
}

.purchases-management .btn-primary:hover {
    background-color: #a86a0c !important;
    border-color: #a86a0c !important;
    color: white !important;
}

.purchases-management .btn-primary:focus,
.purchases-management .btn-primary:active {
    background-color: #a86a0c !important;
    border-color: #a86a0c !important;
    color: white !important;
    box-shadow: 0 0 0 0.2rem rgba(183, 116, 14, 0.25) !important;
}
